...
class TaskDefinition(object):
    ...
    def __init__(self, name, upstream_tasks=None, scala_class=None, jar=ingestion_jar, command=None, package=None,
        ...
        self.jar_attribute = jar_attribute
    ...
    def create_command(self):
        ...
        if self.jar_attribute is not None:
            jar_attribute = "--jars " + self.jar_attribute
        else:
            jar_attribute = ""
        return "ssh bp2016n1@sopedu \"HADOOP_USER_NAME='bp2016n1' spark-submit --class " + full_class_name + \
               " --master yarn " + jar_attribute + "--num-executors 23 --executor-cores 4 --executor-memory 10G "\
               + self.jar + "\""
