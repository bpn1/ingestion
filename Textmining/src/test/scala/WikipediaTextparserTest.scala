...
class WikipediaTextparserTest extends FlatSpec with SharedSparkContext {
	...
	def isTextLinkConsistent(link: WikiClasses.Link, text: String): Boolean = {
		val substring = text.substring(link.offset, link.offset + link.alias.length)
		substring == link.alias
	}

	def isInfoboxLink(link: WikiClasses.Link): Boolean = {
		link.offset == WikipediaTextparser.infoboxOffset
	}

	def isLinkValid(link: WikiClasses.Link): Boolean = {
	...
	def wikipediaTestReferences(): Map[String, List[WikiClasses.Link]] = {
		Map(
			"Audi" -> List(
				// Article text links
				...
				WikiClasses.Link("Volkswagen", "Volkswagen AG", 123),
				WikiClasses.Link("Wortspiel", "Wortspiel", 175),
				WikiClasses.Link("Namensrechte", "Marke (Recht)", 202),
				WikiClasses.Link("A. Horch & Cie. Motorwagenwerke Zwickau", "Horch", 255),
				WikiClasses.Link("August Horch", "August Horch", 316),
				WikiClasses.Link("Lateinische", "Latein", 599),
				WikiClasses.Link("Imperativ", "Imperativ (Modus)", 636),
				WikiClasses.Link("Zwickau", "Zwickau", 829),
				WikiClasses.Link("Zschopauer", "Zschopau", 868),
				WikiClasses.Link("DKW", "DKW", 937),
				WikiClasses.Link("Wanderer", "Wanderer (Unternehmen)", 1071),
				WikiClasses.Link("Auto Union AG", "Auto Union", 1105),
				WikiClasses.Link("Chemnitz", "Chemnitz", 1131),
				WikiClasses.Link("Zweiten Weltkrieg", "Zweiter Weltkrieg", 1358),
				WikiClasses.Link("Ingolstadt", "Ingolstadt", 1423),
				WikiClasses.Link("NSU Motorenwerke AG", "NSU Motorenwerke", 1599),
				WikiClasses.Link("Neckarsulm", "Neckarsulm", 1830),

				// Infobox links
				WikiClasses.Link("Aktiengesellschaft", "Aktiengesellschaft", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Zwickau", "Zwickau", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Chemnitz", "Chemnitz", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Ingolstadt", "Ingolstadt", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Neckarsulm", "Neckarsulm", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Ingolstadt", "Ingolstadt", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Deutschland", "Deutschland", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Rupert Stadler", "Rupert Stadler", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Vorstand", "Vorstand", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Matthias Müller", "Matthias Müller (Manager)", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Aufsichtsrat", "Aufsichtsrat", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Mrd.", "Milliarde", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("EUR", "Euro", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Automobilhersteller", "Automobilhersteller", WikipediaTextparser.infoboxOffset)),

			"Electronic Arts" -> List(
				// Article text links
				WikiClasses.Link("Publisher", "Publisher", 83),
				WikiClasses.Link("Computer- und Videospielen", "Computerspiel", 97),
				WikiClasses.Link("Madden NFL", "Madden NFL", 180),
				WikiClasses.Link("FIFA", "FIFA (Spieleserie)", 192),
				WikiClasses.Link("Vivendi Games", "Vivendi Games", 346),
				WikiClasses.Link("Activision", "Activision", 364),
				WikiClasses.Link("Activision Blizzard", "Activision Blizzard", 378),
				WikiClasses.Link("Nasdaq Composite", "Nasdaq Composite", 675),
				WikiClasses.Link("S&P 500", "S&P 500", 699),

				// Infobox links
				WikiClasses.Link("Corporation", "Gesellschaftsrecht der Vereinigten Staaten#Corporation", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Redwood City", "Redwood City", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("USA", "Vereinigte Staaten", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Larry Probst", "Larry Probst", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("USD", "US-Dollar", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Fiskaljahr", "Geschäftsjahr", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Softwareentwicklung", "Softwareentwicklung", WikipediaTextparser.infoboxOffset)),

			"Abraham Lincoln" -> List(
				// Article text links
				WikiClasses.Link("President of the United States", "President of the United States", 29),

				// Infobox links
				WikiClasses.Link("Hannibal Hamlin", "Hannibal Hamlin", WikipediaTextparser.infoboxOffset),
				WikiClasses.Link("Andrew Johnson", "Andrew Johnson", WikipediaTextparser.infoboxOffset)))
	}
