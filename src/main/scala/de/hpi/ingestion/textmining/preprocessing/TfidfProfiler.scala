...
import de.hpi.ingestion.textmining.preprocessing.CosineContextComparator._
import de.hpi.ingestion.textmining.preprocessing.TermFrequencyCounter.extractArticleContext
...
/**
  ...
  * implementation in the Spark MLlib. (This is just for evaluation and no necessary part of the pipeline.)
  */
